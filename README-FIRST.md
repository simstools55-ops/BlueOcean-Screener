...
## v0.12.0 — Personal Knowledge Separation
...
利用者向け配布物は `distribution/SIMS-BlueOcean-Screener-v0.12.0/` に集約しています。

## 推奨コミットメッセージ

`refactor(bos): separate personal knowledge from distributable product (v0.12.0)`

# SIMS Blue Ocean Screener v0.14.5
...
v0.14.5 は、v0.14.4 の選抜方式を維持したまま、SERP精査依頼を Claude用ZIP と Gemini用Markdown のどちらでも出力できる実運用試験版です。SERP回答欄はClaude / Gemini共通で、aCreator依頼は引き続き1件ずつ処理します。
